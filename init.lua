...
vim.opt.hlsearch = false                  -- Don't hifhlight search results
...
vim.opt.lazyredraw = true                           -- Don_t redraw durign macros
...
vim.opt.undofile = true                             -- Persistend Undo
vim.opt.undodir = vim.fn.expand("~/.vim/undodir")   -- Undo directory
vim.opt.updatetime = 300                            -- Faster completion
vim.opt.timeoutlen = 1500                            -- Key timeout duration
...
vim.opt.iskeyword:append("-")                       -- Tread dash as part of word
...
vim.keymap.set("n", "<leader>sh", ":split<CR>", { desc = "Split window hoizontally" })
...
-- Auto-close terminal when process exists
